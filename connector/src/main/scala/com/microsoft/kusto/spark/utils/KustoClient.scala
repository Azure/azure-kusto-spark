...
import com.microsoft.kusto.spark.datasink.FinalizeHelper.pollOnResult
...
import com.microsoft.kusto.spark.utils.KustoDataSourceUtils.{extractSchemaFromResultTable, reportExceptionAndThrow}
